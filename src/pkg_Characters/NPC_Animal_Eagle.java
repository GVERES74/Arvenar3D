 ...
 * @author VERESG
 */
public class NPC_Animal_Eagle extends NPC_Animal{
    
    public NPC_Animal_Eagle(String fname, String cast, Weapons weapon, String shout, int max_health, String avatarimg, String biography){
