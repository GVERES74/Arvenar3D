 ...
 * @author VERESG
 */
public class NPC_Dwarf_Berserker extends NPC_Dwarf{
    
    public NPC_Dwarf_Berserker(String fname, String cast, Weapons weapon, String shout, int max_health, String avatarimg, String biography){
