 ...
 * @author VERESG
 */
public class NPC_Elf_Mage extends NPC_Elf{
    
    public NPC_Elf_Mage(String fname, String cast, Weapons weapon, String shout, int max_health, String avatarimg, String biography){
