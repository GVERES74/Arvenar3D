 ...
 * @author VERESG
 */
public class NPC_Animal_Snake extends NPC_Animal{
    
    public NPC_Animal_Snake(String fname, String cast, Weapons weapon, String shout, int max_health, String avatarimg, String biography){
